...
int main(int argc, const char* argv[])
{
    ...
    CameraCalibration calibration(624.3991405494345f, 624.9465177605456f, 399.2962272452075f, 294.5902974026438f);
    ...
    if (argc == 2)
    {
        cv::VideoCapture video_capture = cv::VideoCapture(0);
        processVideo(patternImage, calibration, video_capture);
    }
    else if (argc == 3)
    {
